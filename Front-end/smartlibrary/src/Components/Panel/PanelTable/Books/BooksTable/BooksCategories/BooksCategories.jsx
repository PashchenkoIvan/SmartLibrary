...
const BooksCategories = props => {
	...
	const categoriesMap = categories.map(c => 
		<div className={s.singleCategoryContainer}>
			...
			<div>
				<div className={s.categoryColor} style={{ backgroundColor: c.color }}>
				</div>
				<div className={s.categoryBtns}>
					<Popup
						trigger={
							<button className={s.categoryEdit}>
								Редагувати
							</button>
						}
						modal
							...
							<>
								...
								<div className={sp.content}>
									...
									<div className={sp.colorContainer}>
										<label>Колір</label>
										<input id="colorInput" type="color" value={c.color} name={`${c.id}_color`} />
									</div>
					...
					<button className={s.categoryDelete}>
						Видалити
					</button>
				</div>
			</div>
	  ...
	  <div className={s.contentBlock}>
		...
		<div className={s.main}>
			<div className={s.topBar}>
				...
				<input className={s.inputCodeField} type="text" placeholder="Для додавання нової категорії введіть назву і виберіть колір" />
