...
const subFormTableRowAdd = (
	...
	return (
		<div className={s.subFormTableRow}>
			<div className={s.subFormTableCell}>{title}</div>
		...
		<div>
			<div className={s.subFormTable}>
				<div className={`${s.subFormTableRow} ${s.tableHeaderRow}`}>
					<div className={s.subFormTableCell}>Категорія</div>
					<div className={s.subFormTableCell}>Особистий кабінет</div>
					<div className={s.subFormTableCell}>E-mail та особистий кабінет</div>
				</div>
				{subFormTableRowAdd({ subs, setSubs }, 'Новини', 'news')}
				{subFormTableRowAdd(
					{ subs, setSubs },
					'Повідомлення про наявність книги',
					'notification'
				)}
			</div>
			...
			<div className={s.subFormTable}>
				{categories.categories.map(c =>
					subFormTableRowAdd({ subs, setSubs }, c.title, c.id)
				)}
			</div>
		</div>
	);
...
const Popups = () => {
	...
	return (
		<>
			<Popup trigger={<button>Редагувати пароль</button>} modal>
				{close => (
					<>
			...
			<Popup trigger={<button>Мої підписки</button>} modal>
				{close => (
					<>
						<div className={sp.header}>
